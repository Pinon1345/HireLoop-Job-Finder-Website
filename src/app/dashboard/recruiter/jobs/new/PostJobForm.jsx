    ...
    return (
        <div className="min-h-screen bg-[#0F0F10] text-[#E4E4E7] flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-between items-start border-b border-[#27272A] pb-6 mb-8">
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-3">
                            ...
                            <Chip
                                color={companyStatus === "approved" ? "success" : "warning"}
                                variant="flat"
                                size="sm"
...

            {
                ...
                <div className="w-full max-w-3xl bg-[#18181B] border border-[#27272A] rounded-xl shadow-lg overflow-hidden p-8 shadow-blue-600 flex justify-center items-center gap-2 flex-col mt-6">
                    <AiFillAlert className="text-yellow-500 text-4xl"></AiFillAlert>
                    <p className="mt-2 text-lg">Sorry Sir/Madam</p>
                    <p className="text-zinc-400">This Company you want to create a job is not still approved by Admin.</p>
                    <h2 className="text-yellow-600 mt-2 font-bold text-xl">Please wait for Admin Approval.</h2>
                </div>
            }
            {
                company.status === "Rejected" &&
                <div className="w-full max-w-3xl bg-[#18181B] border border-[#27272A] rounded-xl shadow-lg overflow-hidden p-8 shadow-blue-600 flex justify-center items-center gap-2 flex-col mt-6">
                    <AiFillAlert className="text-red-500 text-4xl"></AiFillAlert>
                    <p className="mt-2 text-lg">Sorry Sir/Madam</p>
                    <p className="text-zinc-400">This Company you want to create a job is <span className="font-bold text-red-400">Rejected</span> by Admin.</p>
                    <h2 className="text-red-600 mt-2 font-bold text-xl">Please Try Another Company.</h2>
                </div>
            }
